...
export default class Service extends React.Component{
    ...
    serviceInput = React.createRef();
    serviceDateInput = React.createRef();
    reqInput = React.createRef();
    validateForm(){
                        ...
                        <h1 class="text-white mb-4">Book For A Service</h1>
                            ...
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" ref={this.nameInput} class="form-control border-0" placeholder="Your Name" />
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="email" ref={this.emailInput} class="form-control border-0" placeholder="Your Email"/>
                                </div>
                                <div class="col-12 col-sm-6">
                                ...
                                <div class="col-12">
                                    <button onClick={()=>this.validateForm()} class="btn btn-secondary w-100 py-3" type="submit">Book Now</button>
                                </div>
                            </div>
