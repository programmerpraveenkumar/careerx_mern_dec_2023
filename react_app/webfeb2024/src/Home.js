            ...
            <div className="row g-5">
                <div className="col-lg-6 pt-4" >
                    <div className="position-relative h-100 wow fadeIn" data-wow-delay="0.1s">
                        <img className="position-absolute img-fluid w-100 h-100" src="assets/img/about.jpg" />
                        <div className="position-absolute top-0 end-0 mt-n4 me-n4 py-4 px-5" >
                            <h1 className="display-4 text-white mb-0">15sef <span className="fs-4">Years</span></h1>
